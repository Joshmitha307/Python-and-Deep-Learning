...
training_data = Path('./drive/My Drive/10-monkey-species/training')
validation_data = Path('./drive/My Drive/10-monkey-species/validation')
labels_path = Path('./drive/My Drive/10-monkey-species/monkey_labels.txt')
